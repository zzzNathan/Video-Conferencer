...
username and passcode system. A detailed justification for this
...
able to interact with the videoconferences by raising their 
...
the opportunity to improve their social lifes as they will be
...
clickable icons centered in the screen, each with their own
...
microphones buit-in. So the microphone and video camera
will be able to collect the same data as was discussed 
in the preceeding paragraph. The only difference is that
...
\textit{Justification:}
In the context of updating our sytem, we would like to avoid
...
delivery) pipeline. This descision may save us from 
...
for a video conferecing application, since the 
...
the new code that they add to the system's backend.
...
and shouldn't be especially our software maintainence team.
