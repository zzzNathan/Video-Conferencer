...
be noticably seperate without disturbing the user's attention.
I may think to use these same colour scheming ideas in my final 
UI design.
...
panel, due to the high likelyhood that my target audience 
will have trouble seeing the icons when they are so small. 
Finally I will make steps to avoid the issue of having too 
