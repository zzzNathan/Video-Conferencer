...
\begin{algorithmic}[1]
  \Function{Set\_User\_cfgs}{Username, Option, Value}
    ...
    \Let{ConfigID}{Query\_tbl(Logins, Username, ConfigID)}
    \Let{Config}{Create\_cfg(ConfigID)} \Comment{Let Config be an object storing the user's current settings.}
...
\textit{Iterative test plan: (Assume that the user "Warren2" exist in the database).} \vspace{0.2cm} \\
