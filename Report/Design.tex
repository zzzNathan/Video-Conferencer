...
\begin{tikzpicture}[
  ...
  \node (end)   [base, terminal, below=of anchor] {End};
  ...
  \draw[draw, -{Latex[length=2.5mm]}] (doc.south)   |- (end);
  \draw[draw, -{Latex[length=2.5mm]}] (reg.south)   |- (end);
  \draw[draw, -{Latex[length=2.5mm]}] (help.south)  |- (end);
  \draw[draw, -{Latex[length=2.5mm]}] (sign.south)  |- (end);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[
  ...
  \node (end)   [base, terminal, below=of login] {End};
...
\begin{tikzpicture}[
  ...
  \node (end)   [base, terminal, below=of audio] {End};
