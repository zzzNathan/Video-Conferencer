...
{\sffamily Task:} Create an account.\\ \vspace{0.2cm}

{\color{gray} \hrulefill}

{\sffamily Steps:}\\ \vspace{0.1cm}
...
{\sffamily Expected outcome:} User account created successfully. \\ \vspace{0.2cm}

{\color{gray} \hrulefill}

{\sffamily Test type: Extreme.}\\ \vspace{0.2cm}

Repeat the steps except use the password \texttt{AopS12v}.\\ \vspace{0.2cm}

{\sffamily Expected outcome:} User account created successfully.\\ \vspace{0.2cm}

{\color{gray} \hrulefill}

{\sffamily Erroneous} \\ \vspace{0.2cm}

Repeat the steps except use the password \texttt{123}. \\ \vspace{0.2cm}
