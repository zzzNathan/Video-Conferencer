...
\textit{Description:}  & {This function should take in a user's username and password and then set up their relevant 
                          configurations. Their customised settings should all be correctly loaded into the system, once we have
			  confirmed that the user has successfully logged in.}\\

\textit{Justification:} & {The initiative to provide accessibility options and configurations was suggested by my client as a 
                           non-essential feature as was seen in section \ref{sec:interview}. We justify confirming that the
