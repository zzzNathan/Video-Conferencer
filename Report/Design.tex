...
\subsection{Entity relationship diagram — \textit{1st draft}}
\label{sec:erdd}
...
\subsection{Entity relationship diagram — \textit{2nd draft}}
...
\subsection{Entity relationship diagram — \textit{3rd draft}}
...
\subsection{Entity relationship diagram — \textit{4th draft}}
...
\subsection{Proposed system level 0 DFD}
...
\subsection{Proposed system level 1 DFD} 
...
{Username} & \texttt{string} & {A unique string that will be used to 
identify a user.} & {Unique usernames help other users to identify the the 
identities of the other participants who are in their call. Since they are 
unique they can also form a primary key as we are doing so in the 
{\sffamily Logins} table.}\\
...
the microphone volume should sound to others.} & {}\\
