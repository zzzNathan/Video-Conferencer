...
\textit{Function name:} & {\scshape Add\_Account(\texttt{string} Username, \texttt{string} Password)}\\
...
\begin{algorithmic}[1]
  \Function{Add\_Account}{Username, Password}
    ...
    \State{Update\_tbl(Logins, Username, Password)} 
    \State{Set\_cfgs(Username, DEFAULT)} \Comment{Set default settings for new user.}
    \State{}
