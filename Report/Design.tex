...
In the 4th draft, the logical relations between the
attributes in each of the tables has changed as well
as the manner in which we have presented these 
relationships, due to requests from my client, Axel.
Each primary to foreign key relationship is now 
represented with an arrow that points directly to 
to the name of it's corresponding key.
