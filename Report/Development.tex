...
<body>
  ...
  <ul id="Navbar">
    ...
    <li id="Contact_container">
      <object id="Contact" data="Images/Contact.svg" type="image/svg+xml">
        <img src="Images/Contact.png">
      </object>
    </li>

    <li id="Support_container">
      <object id="Support" data="Images/Support.svg" type="image/svg+xml">
...
\begin{minted}[linenos, bgcolor=lightestgray]{sass}
// Colour definitions
$Col_Main:       #3F3E3C // Dark purple
$Col_Secondary:  #B98DEE // Purple
$Col_Tertiary:   #FFC6E5 // Pink
...
format using a \texttt{.svg} graphic. Finally I 
...
\begin{minted}[linenos, bgcolor=lightestgray]{sass}
...
$Col_Gradient:    #423652 // Darker purple
...
our home page and login page together.
