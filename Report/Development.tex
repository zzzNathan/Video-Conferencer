...
\texttt{VideoConferencer-Iteration2}}. \\ \vspace{0.2cm}
...
\begin{itemize}
\item User can register an account \faCheck
\item User can sign in to their account \faCheck
\item User can logout of their account \faCheck
\end{itemize}

{\sffamily Evidence: } \url{https://youtu.be/Fdg2HYeOV4Q} \\ \vspace{0.2cm}

\textit{Note: I had intitially forgotten to run this test so I came back and ran it at a later date, hence why the
...
We also do some input validation on the front end,
...
Look at github commit \texttt{3bc8b0669f858431c08b600c32f00d97771319ef} to see the state of the project after our 4th iteration. \\ \vspace{0.2cm}

Alternatively click the following link to view the state of our project at this point in development: \\
\href{https://github.com/zzzNathan/Video-Conferencer/tree/3bc8b0669f858431c08b600c32f00d97771319ef}{\texttt{VideoConferencer-Iteration5}}
