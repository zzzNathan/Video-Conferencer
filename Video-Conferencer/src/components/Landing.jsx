  ...
  return (
    <div className="w-screen h-screen flex flex-col">
      ...
      <div className="flex flex-row justify-center items-center space-x-[1.75vw]  p-0 mb-auto pointer-events-auto">
        ...
        <a href="/registration">
          <BackgroundGradient>
	  <button className="rounded-[50vw] bg-gradient-to-r from-ter to-sec/70 bg-gradient-to-bl from-bg/70 to-pink/70 text-black hover:border-[0.15vw] px-[1.75vw] border-t-[0.15vw] py-[0.7vw] transition-all text-[1.3vw]"> Sign up
	  </button>
	  </BackgroundGradient>
	</a>
      </div>

      <img className="translate-y-[2vw] w-[100vw]" src={Quotes} /> 
    </div>
  )
}
