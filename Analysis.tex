...
\subsection{Essential features \& their justifications}
...
target demographic. If a user has forgotten their password they
...
forgets their password multiple times. \\ \vspace{0.2cm}
...
\ref{sec:research}. Signalling servers aren't available free
of charge, for example Google Firebase charges nothing for the 
