...
matches in the sequence $m$. More formally the algorithm
computes
...
cause issues very similar to the anarchy that was discussed
...
codecs that we choose to use in the beginning of the peer to
peer connection. This will be handled by the WebRTC API once
the video call starts. Audio and video compression is 
...
data is completly secure during video calls. 

\subsection{Backing up data}

Data backups will be made nightly (every 24 hours) to ensure
that none of our user's data is lost.
