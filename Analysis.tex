...
user whilst they are typing in their password. These kinds of 
issues may lead to a breach of data protection regulations and
users having their private information stolen.
...
internet connection and access to a standard web browser. For 
a video conference with 2 participants a minimum download
speed of 5 Mbit/s and a minimum upload speed of 3 Mbit/s will
be required. For optimal performance we recommend having a 
device with the following specifaction or better:

\begin{itemize}
  \item Processor: Dual core 2 GHz processor
  \item Ram: 5 GB of RAM
\end{itemize}

These requirements are based on the old systems requirements.
\footnote{Source: \url{https://support.zoom.com/hc/en/article?id=zm_kb&sysparm_article=KB0060748}}
...
Data capture & {A videocamera and a microphone that are connected
		...
		the real world. (See: \url{https://www.apple.com/apple-vision-pro/})
	        }\\
...
\textbf{1 - The video call latency should not exceed 150 ms}
...
\url{https://support.zoom.com/hc/en/article?id=zm_kb&sysparm_article=KB0070504}} so we will seek to match this
value.
