...
used. To justify this claim we look at the average download
speeds for UK resedentials and compare it to the amount of 
data needed to transfer clear video and audio for 1 second.
\textit{"The average download speed of a UK home broadband
was 69.4 Mbit/s"} \cite{data}. For professional video 
applications RGB true colour is the standard, where 24 bits are
used to store the colour of each pixel. For a 720p display we 
have $(1,280 \times 720) \times 24 = 22,118,400$ bits for one 
image. Standard video chat applications all apply the
\textit{discrete cosine transform} in order to compress video.
\cite{cosine}
Moreover we have evidence from the previous systems like 
...
demonstrate the validity and feasability of a computational
approach towards solving this problem.  \vspace{0.2cm}
...
\footnote{As of 2024.} \\ \vspace{0.2cm}
