...
feasability of a computational approach towards solving this
...
device share it to others with negligable latency. The problem
of sharing real-time audio/video feeds between users can be 
decomposed into numerous sub-problems that are easier to
accomplish. For example we could break this problem into 4 
sub-problems:
...
goal. The feature of real-time audio and video is implicitly 
necessary for a video conferencing application and is also 
fully justified in the paragraph before this. \vspace{0.2cm}
...
on Zoom (Zoombombing), and in order to provide the best
...
like where will the database be hosted? These concerns fully 
