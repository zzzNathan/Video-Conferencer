...
\usepackage{fancyhdr, tcolorbox, xcolor, amsthm, xurl, tabularray, algorithmicx, algorithm}
\usepackage{minted, hyperref, tikz, graphicx, amssymb, amsfonts, titlesec, lmodern}
\usepackage{biblatex, erd, amsmath, fontawesome}
