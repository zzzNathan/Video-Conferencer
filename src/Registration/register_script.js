...
function Try_Create_Account() 
{
  ...
  const name_msg  = ["Name must be at least 3 characters"];

  var result_email = Check_Email();
  var result_name  = Check_Username();
  var result_pass  = Check_Password();

  // If nothing is wrong with the username and password then 
  // we can contact backend to verify whether or not username,
  // password and email are available.
  if (result_email && result_name && result_pass) {
